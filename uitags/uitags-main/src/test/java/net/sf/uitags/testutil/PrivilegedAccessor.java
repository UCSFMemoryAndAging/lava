package net.sf.uitags.testutil;
...
public final class PrivilegedAccessor {
   ...
   * @throws IllegalAccessException to communicate error
   * @throws NoSuchFieldException to communicate error
   */
   ...
   * @throws NoSuchMethodException to communicate error
   * @throws IllegalAccessException to communicate error
   * @throws InvocationTargetException to communicate error
   * @return the object
   */
  public static Object invokeMethod(
      Object instance, String methodName, Object arg)
  ...
  public static Object invokeMethod(
      ...
      return getMethod(instance,methodName, 
          classTypes).invoke(instance, args);
  }
  ...
  public static Method getMethod(Object instance, String methodName,
      ...
      Method accessMethod = getMethod(
          instance.getClass(), methodName, classTypes);
