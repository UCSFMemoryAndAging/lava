...
/**
 * Injects the functionality for the target box of an option transfer suite.
 *
 * @author hgani
 * @version $Id$
 */
public class TargetTag extends AbstractUiTag {
  ...
  public int doStartTag() throws JspException {
    ...
    parent.registerTargetLister(this.injectTo, this.injectToName);
