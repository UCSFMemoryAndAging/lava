...
/**
 * Injects the functionality to return all items in the target
 * box to the source box of the option transfer suite.
 *
 * @author hgani
 * @version $Id$
 */
public class ReturnAllTag extends AbstractUiTag {
  ...
  public int doStartTag() throws JspException {
    ...
    Template tpl = Template.forName(Template.OPTION_TRANSFER_RETURN_ALL);
