...
/**
 * Injects the functionality to transfer all items in the source
 * box to the target box of the option transfer suite.
 *
 * @author hgani
 * @version $Id$
 */
public class TransferAllTag extends AbstractUiTag {
  ...
  public int doStartTag() throws JspException {
    ...
    Template tpl = Template.forName(Template.OPTION_TRANSFER_TRANSFER_ALL);
