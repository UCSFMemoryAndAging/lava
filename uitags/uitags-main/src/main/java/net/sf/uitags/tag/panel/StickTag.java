...
/**
 * Injects a stick capability to a widget of a panel.
 *
 * @author hgani
 * @version $Id$
 */
public class StickTag extends AbstractUiTag {
  ...
  public int doEndTag() throws JspException {
    ...
    Template tpl = Template.forName(Template.PANEL_STICK);
    tpl.map("stickerId", this.injectTo);
    tpl.map("stickerName", this.injectToName);
