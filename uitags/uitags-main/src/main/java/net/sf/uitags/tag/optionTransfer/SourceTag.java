...
/**
 * Injects the functionality for the source box of an option transfer suite.
 *
 * @author hgani
 * @version $Id$
 */
public class SourceTag extends AbstractUiTag {
  ...
  /**
   * Registers to the parent and prints the necessary Javascript code.
   *
  ...
  public int doStartTag() throws JspException {
    ...
    parent.registerSourceLister(this.injectTo, this.injectToName);
