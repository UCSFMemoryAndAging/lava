 ...
 * @version $Id$
 */
public class HideTag extends AbstractUiTag {
  ...
  /**
   * Renders the HTML code for hiding a panel.
   *
  ...
  public int doEndTag() throws JspException {
    ...
    Template tpl = Template.forName(Template.PANEL_HIDE);
    ...
    tpl.map("force", Boolean.valueOf(this.force));
