...
//	private int indexInstrCaregiverId;  believe this was never used. took different approach to caregiver instruments
	...
	public void reset() {
		...
		this.instrCreated = this.instrExisted = this.instrExistedWithData = this.instrExistedWithDataNoUpdate = false;
		this.instrument2 = null;
		this.instr2Created = this.instr2Existed = this.instr2ExistedWithData = this.instr2ExistedWithDataNoUpdate = false;
		this.instrument3 = null;
		this.instr3Created = this.instr3Existed = this.instr3ExistedWithData = this.instr3ExistedWithDataNoUpdate = false;
		this.instrument4 = null;
		this.instr4Created = this.instr4Existed = this.instr4ExistedWithData = this.instr4ExistedWithDataNoUpdate = false;
		this.instrument5 = null;
		this.instr5Created = this.instr5Existed = this.instr5ExistedWithData = this.instr5ExistedWithDataNoUpdate = false;
		this.instrument6 = null;
		this.instr6Created = this.instr6Existed = this.instr6ExistedWithData = this.instr6ExistedWithDataNoUpdate = false;
		this.instrument7 = null;
		this.instr7Created = this.instr7Existed = this.instr7ExistedWithData = this.instr7ExistedWithDataNoUpdate = false;
		this.instrument8 = null;
		this.instr8Created = this.instr8Existed = this.instr8ExistedWithData = this.instr8ExistedWithDataNoUpdate = false;
		this.instrument9 = null;
		this.instr9Created = this.instr9Existed = this.instr9ExistedWithData = this.instr9ExistedWithDataNoUpdate = false;
		this.instrument10 = null;
		this.instr10Created = this.instr10Existed = this.instr10ExistedWithData = this.instr10ExistedWithDataNoUpdate = false;
		this.instrument11 = null;
		this.instr11Created = this.instr11Existed = this.instr11ExistedWithData = this.instr11ExistedWithDataNoUpdate = false;
		this.instrument12 = null;
		this.instr12Created = this.instr12Existed = this.instr12ExistedWithData = this.instr12ExistedWithDataNoUpdate = false;
		this.instrument13 = null;
		this.instr13Created = this.instr13Existed = this.instr13ExistedWithData = this.instr13ExistedWithDataNoUpdate = false;
		this.instrument14 = null;
		this.instr14Created = this.instr14Existed = this.instr14ExistedWithData = this.instr14ExistedWithDataNoUpdate = false;
		this.instrument15 = null;
		this.instr15Created = this.instr15Existed = this.instr15ExistedWithData = this.instr15ExistedWithDataNoUpdate = false;
	}
