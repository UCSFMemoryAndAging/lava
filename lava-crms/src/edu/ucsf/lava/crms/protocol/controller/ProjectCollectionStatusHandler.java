...
public class ProjectCollectionStatusHandler extends BaseCollectionStatusHandler {

	public ProjectCollectionStatusHandler() {
		super();
		this.setHandledList("projectCollectionStatus","protocolStatusList");
	}
