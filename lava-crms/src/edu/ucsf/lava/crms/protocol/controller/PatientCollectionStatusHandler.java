...
public class PatientCollectionStatusHandler extends BaseCollectionStatusHandler {

	public PatientCollectionStatusHandler() {
		super();
		this.setHandledList("patientCollectionStatus","protocolStatusList");
	}
