...
public class PatientPatientProtocolsHandler extends CrmsListComponentHandler {

	public PatientPatientProtocolsHandler() {
		super();
		CrmsSessionUtils.setIsPatientContext(this);
		this.setHandledList("patientPatientProtocols","patientProtocol");
