...
public class ProjectDeviationStatusHandler extends BaseDeviationStatusHandler {

	public ProjectDeviationStatusHandler() {
		super();
		this.setHandledList("projectDeviationStatus","protocolStatusList");
	}
