...
public class PatientCompletionStatusHandler extends BaseCompletionStatusHandler {

	public PatientCompletionStatusHandler() {
		super();
		this.setHandledList("patientCompletionStatus","protocolStatusList");
	}
