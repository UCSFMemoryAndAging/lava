...
public class ProjectSchedulingStatusHandler extends BaseSchedulingStatusHandler {

	public ProjectSchedulingStatusHandler() {
		super();
		this.setHandledList("projectSchedulingStatus","protocolStatusList");
	}
