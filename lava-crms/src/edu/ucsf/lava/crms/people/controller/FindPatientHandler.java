...
public class FindPatientHandler extends CrmsListComponentHandler {
	...
	public LavaDaoFilter extractFilterFromRequest(RequestContext context,
		...
		LavaDaoFilter f = CrmsSessionUtils.setFilterProjectContext(
				sessionManager, request, Patient.newFilterInstance(
						getCurrentUser(request)).addDefaultSort("fullNameRevNoSuffix",true));	
