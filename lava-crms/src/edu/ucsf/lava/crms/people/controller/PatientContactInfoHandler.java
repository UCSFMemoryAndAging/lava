...
public class PatientContactInfoHandler extends CrmsListComponentHandler {

	public PatientContactInfoHandler() {
		this.setHandledList("patientContactInfo","contactInfo");
