...
<c:set var="instrTypeEncoded" value="udsdiagnosis1"/>
...
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsdiagnosis1.1-4.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
...
<tags:outputText textKey="udsdiagnosis1.normCog.instructions" inline="false" associated="true"/>
<tags:createField property="demented" entity="${instrTypeEncoded}" component="${component}"/>
<tags:outputText textKey="udsdiagnosis1.noNormCog_noDemented.instructions" inline="false" hangingIndent="true"/>

<tags:tableForm>  
<tags:listRow>
<tags:listColumnHeader labelKey="udsdiagnosis1.noNormCog_noDemented.presentColHeader" width="58%"/>
<tags:listColumnHeader labelKey="udsdiagnosis1.noNormCog_noDemented.domainsColHeader" width="42%"/>
</tags:listRow>
...
<tags:createField property="notes['udsd114']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>

<tags:sectionQuicklink requestUrl="${requestUrl}" sectionId="top" sourceSectionId="udsd1512" linkTextKey="top.quicklink"/>
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsdiagnosis1.5-12.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
  <page:param name="instructions"> </page:param>
...
<tags:createField property="notes['udsd1512']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>

<tags:sectionQuicklink requestUrl="${requestUrl}" sectionId="top" sourceSectionId="udsd11327" linkTextKey="top.quicklink"/>
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsdiagnosis1.13-27.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
  <page:param name="instructions"> </page:param>
...
<tags:createField property="notes['udsd11327']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
...
<ui:formGuide>
  ...
  <ui:skip elementIds="demented,mciaMem,mciaPlus,mciaPLan,mciaPAtt,mciaPEx,mciaPVis,mciNon1,mciN1Lan,mciN1Att,mciN1Ex,mciN1Vis,
  	mciNon2,mciN2Lan,mciN2Att,mciN2Ex,mciN2Vis,impNoMci,probAd,probAdIf,possAd,possAdIf,dlb,dlbIf,vasc,vascIf,alcDem,alcDemIf,
