...
<c:set var="instrTypeEncoded" value="udscdr1"/>
...
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udscdr1.cdr.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
...
<tags:createField property="notes['cdr']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
