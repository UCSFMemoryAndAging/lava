...
<c:set var="instrTypeEncoded" value="udsfaq1"/>
...
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsfaq1.faq.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
...
<tags:createField property="notes['faq']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
