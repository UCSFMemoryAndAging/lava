...
<c:set var="instrTypeEncoded" value="udsinformantdemo2"/>
...
<page:applyDecorator name="component.instrument.section">
	...
	<page:param name="view">${componentView}</page:param>
	<page:param name="instructions"> </page:param>
	<tags:createField property="notes['udsinformantdemo']" entity="${entity}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
