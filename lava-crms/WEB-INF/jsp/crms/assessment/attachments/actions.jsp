...
<a href="<tags:actionURL actionId="lava.crms.assessment.attachments.patientAttachments" idParam="${currentPatient.id}"/>">
...
<!--  project actions -->
 <a href="<tags:actionURL actionId="lava.crms.assessment.attachments.projectPatientAttachments" />">
