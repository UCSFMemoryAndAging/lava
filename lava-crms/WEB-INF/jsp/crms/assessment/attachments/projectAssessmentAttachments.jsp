...
<c:set var="component" value="projectAssessmentAttachments"/>
...
<content tag="customActions">
	<tags:actionURLButton buttonText="Add" actionId="lava.crms.assessment.attachments.assessmentAttachment" eventId="assessmentAttachment__add" component="${component}"/>	    
...
<content tag="listQuickFilter">
	...
	<a class="listControlBarActionCurrent"  href="<tags:actionURL actionId="lava.crms.assessment.attachments.projectAssessmentAttachments"/>">Assessment PDFs</a>
</content>
