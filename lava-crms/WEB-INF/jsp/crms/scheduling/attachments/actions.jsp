...
<a href="<tags:actionURL actionId="lava.crms.scheduling.attachments.patientAttachments" idParam="${currentPatient.id}"/>">
<spring:message code="action.lava.crms.people.attachments.patientAttachments.list"/></a><br>

<a href="<tags:actionURL actionId="lava.crms.scheduling.attachments.visitAttachment" startMode="add"/>">
<spring:message code="action.lava.crms.people.attachments.patientAttachment.add"/></a><br>

</c:if>

<!--  project actions -->
 <a href="<tags:actionURL actionId="lava.crms.scheduling.attachments.projectPatientAttachments" />">
