...
<c:set var="component" value="projectCompletionStatus"/>
...
<content tag="listFilters">
	...
	<tags:contentColumn columnClass="colRight2Col5050">
		<tags:listFilterField property="compStatus" component="${component}" entityType="protocolStatusList"/>
		<tags:listFilterField property="compReason" component="${component}" entityType="protocolStatusList"/>
	</tags:contentColumn>
</content>
