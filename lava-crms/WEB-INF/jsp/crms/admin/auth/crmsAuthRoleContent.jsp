...
<page:applyDecorator name="component.entity.section">
  ...
  <page:param name="sectionNameKey">authRole.details.section</page:param>
	...
	<tags:createField property="patientAccess" component="${component}" entity="crmsAuthRole"/>
	<tags:createField property="phiAccess" component="${component}" entity="crmsAuthRole"/>
	<tags:createField property="ghiAccess" component="${component}" entity="crmsAuthRole"/>
</page:applyDecorator>  
