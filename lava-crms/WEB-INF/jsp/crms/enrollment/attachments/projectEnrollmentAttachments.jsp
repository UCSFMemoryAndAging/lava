...
<c:set var="component" value="projectEnrollmentAttachments"/>
...
<content tag="customActions">
	<tags:actionURLButton buttonText="Add" actionId="lava.crms.enrollment.attachments.enrollmentAttachment" eventId="enrollmentAttachment__add" component="${component}"/>
</content>
</c:if>

<content tag="listQuickFilter">
	<a class="listControlBarAction" href="<tags:actionURL actionId="lava.crms.people.attachments.projectPatientAttachments"/>">All PDFs</a> | 
	<a class="listControlBarActionCurrent" href="<tags:actionURL actionId="lava.crms.enrollment.attachments.projectEnrollmentAttachments"/>">Enrollment PDFs</a> | 
