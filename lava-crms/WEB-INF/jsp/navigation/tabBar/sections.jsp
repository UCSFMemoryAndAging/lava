<%@ include file="/WEB-INF/jsp/includes/include.jsp" %>
    ...
    <tags:crmsNavSection module="people" section="task" textCode="section.task"/>
    <tags:crmsNavSection module="people" section="attachments" textCode="section.attachments" lastSection="true"/>
    ...
    <tags:crmsNavSection module="scheduling" section="projectCalendar" textCode="section.projectCalendar"/>
    <tags:crmsNavSection module="scheduling" section="attachments" textCode="section.attachments"  lastSection="true"/>
