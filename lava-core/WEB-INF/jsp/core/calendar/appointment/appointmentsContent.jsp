...
<content tag="customActions">
	<tags:actionURLButton buttonText="Add Appointment"  actionId="lava.core.calendar.appointment.appointment" eventId="appointment__add" component="${component}" parameters="calendarId,${calendarId}" />	    
</content>
...
<tags:list component="${component}">
	<tags:listRow>
		...
		<tags:listCell>
			<tags:listField property="organizer.userName" component="${component}" listIndex="${iterator.index}" entityType="appointment"/>
		</tags:listCell>
		<tags:listCell>
