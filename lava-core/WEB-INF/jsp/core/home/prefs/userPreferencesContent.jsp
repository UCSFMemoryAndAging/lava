...
<content tag="customActions">
	<c:if test="${componentView=='view'}">
		<tags:actionURLButton buttonText="Change Password"  actionId="lava.core.home.prefs.changePassword" eventId="changePassword__change" component="${component}" />	    
	</c:if>
</content>

<page:applyDecorator name="component.entity.section">
  <page:param name="sectionId">details</page:param>
  <page:param name="sectionNameKey">userPreferences.details.section</page:param>
