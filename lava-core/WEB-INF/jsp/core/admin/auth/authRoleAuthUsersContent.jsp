...
<tags:list component="${component}">
	<tags:listRow>
			...
			<tags:listCell>
				<tags:listField property="user.userNameWithStatus" component="${component}" listIndex="${iterator.index}" entityType="authUserRole" metadataName="user.userNameWithStatus"/>
			</tags:listCell>
