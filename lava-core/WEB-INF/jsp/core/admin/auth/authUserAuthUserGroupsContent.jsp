...
<tags:list component="${component}">
	<tags:listRow>
		...
		<tags:listCell>
			<tags:listField property="group.groupNameWithStatus" component="${component}" listIndex="${iterator.index}" entityType="authUserGroup" metadataName="authGroup.groupNameWithStatus"/>
		</tags:listCell>
		<tags:listCell>
