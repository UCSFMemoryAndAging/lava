...
<tags:listActionURLButton buttonImage="edit" actionId="${actionId}" eventId="${component}__edit" idParam="${idParam}" parameters="${parameters}"/>	    
<tags:listActionURLButton buttonImage="delete" actionId="${actionId}" eventId="${component}__delete" idParam="${idParam}" parameters="${parameters}"/>	    
