 ...
 */
class PasswordResetFlowBuilder extends BaseFlowBuilder {
	
	public PasswordResetFlowBuilder(LavaFlowRegistrar registry, String actionId) {
    ...
    public void buildEventStates() throws FlowBuilderException {
    	...
    	addViewState(getFlowEvent(), 
    			...
    			new Transition[] { 
                    ...
                    transition(on(objectName + "__reset"), to("finish"), 
