...
class ListViewFlowBuilder extends BaseFlowBuilder {
    ...
    public void buildEventStates() throws FlowBuilderException {
    	...
    	// the export event sets the HTTP response headers and content and as a result, the logical view 
    	// generated by CustomViewSelector/CustomReportSelector and any configured Spring ViewResolvers 
    	// are ignored. the browser acts accordingly based on the response header settings. 
    	addViewState("export", 
    			null, formAction.getCustomReportSelector(), 
    			new Action[]{invoke("prepareToRender",formAction)},
