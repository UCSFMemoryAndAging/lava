...
CREATE TABLE `listvalues` (
  ...
  KEY `list__ListID` (`ListID`),
  CONSTRAINT `list__ListID` FOREIGN KEY (`ListID`) REFERENCES `list` (`ListID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `versionhistory` VALUES ('lava-core-model','3.0.3','2009-07-01 11:15:25',3,0,3,1);
...
/*!50013 DEFINER=`root`@`128.218.92.41` SQL SECURITY DEFINER */
...
-- Dump completed on 2009-07-01 18:18:54
