...
CREATE  TABLE IF NOT EXISTS `listvalues` (
  ...
  `ValueDesc` VARCHAR(255) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `lava_file` (
  ...
  `file_status_by` VARCHAR(50) NULL ,
...
CREATE  TABLE IF NOT EXISTS `datadictionary` (
  ...
  `scope` VARCHAR(25) NOT NULL ,
  `entity` VARCHAR(100) NOT NULL ,
  `prop_order` SMALLINT NULL DEFAULT NULL ,
